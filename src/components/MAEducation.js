          ...
          <div className="ma-bottom-container">
            ...
            >
              <div className="ma-about-program-card">
                <div className="ma-about-card-header">
                  <img src={aboutOverlay} alt="Program Icon" className="ma-about-icon" />
              ...
              <div className="ma-info-card career-prospects-card">
                <div className="ma-about-card-header">
                  <img src={careerOverlay} alt="Career Icon" className="ma-about-icon no-bg-icon animate-bounce-subtle" />
            ...
            >
              <div className="ma-info-card">
                <div className="ma-about-card-header">
                  <img src={eligibilityOverlay} alt="Eligibility Icon" className="ma-about-icon small-icon" />
                ...
                <div className="ma-card-buttons">
                  ...
                  <button className="ma-btn-info animate-pulse-button" style={{ animationDelay: '0.1s' }}>Get More Info</button>
                </div>
              </div>
